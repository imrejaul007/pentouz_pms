...
async function verifyTemplates() {
  ...
  try {
    const currentUserHotelId = '68bc094f80c86bfe258e172b'; // Your current user's hotelId
    
    console.log('🔍 Checking templates for current user hotelId...');
    console.log('🏨 Current user hotelId:', currentUserHotelId);
    
    // Test the exact same query that getTemplates uses
    ...
    if (templates.length > 0) {
      ...
      // Check if there are templates with other hotelIds
